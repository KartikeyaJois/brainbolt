...
func NewLeaderboardService(userRepo *UserRepository, leaderboardRepo *LeaderboardRepository) *LeaderboardService {
...
func (s *LeaderboardService) GetLeaderboardEntriesByScore(limit int) ([]LeaderboardEntry, error) {
...
func (s *LeaderboardService) GetLeaderboardEntriesByStreak(limit int) ([]StreakLeaderboardEntry, error) {
